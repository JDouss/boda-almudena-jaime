      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-sage-600 text-xl leading-relaxed">
            Lo mas importante para nosotros es compartir este día tan especial con vosotros. Dicho esto, si queréis hacernos un regalo os dejamos nuestro número de cuenta:          </p>

      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="animate-scale-in">
            <img 
              src="https://www.flickr.com/photos/mroa/7240563876"
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="animate-scale-in">
            <img 
              src="https://github.com/JDouss/spain-wedding-fiesta-vibes/blob/main/src/components/Screenshot%202025-06-16%20at%2022.34.39.png"
